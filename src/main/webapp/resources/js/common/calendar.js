	...
	var imgDir = getContextPath() + "/resources/images/calendar/";			// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	if (dom){
		document.write ("<div onclick='bShow=true' id='calendar' style='z-index:+999;position:absolute;visibility:hidden;background:#fff;'>" +
				"<table cellspacing='0' width="+((showWeekNumber==1)?250:210)+" style='font-family:arial;font-size:13px;border:solid 1px #395d9c;' >" +
					"<tr>" +
						"<td>" +
							"<table width='"+((showWeekNumber==1)?248:210)+"'>" +
								"<tr>" +
									"<td style='padding:2px;font-family:arial; font-size:13px;'><font color='#000000'><B><span id='caption'></span></B></font></td>" +
									"<td align=right><a href='javascript:hideCalendar()'><img src='"+imgDir+"close.gif' style='width:15px; height:13px; border:1px;' alt='Close the Calendar'></a></td>" +
								"</tr>" +
							"</table>" +
						"</td>" +
					"</tr>" +
		...
		if (showToday==1){
			document.write ("<tr><td style='padding:5px' align=center><span id='lblToday'></span></td></tr>");
		}

		document.write ("</table></div><div id='selectYear' style='z-index:+999;position:absolute;visibility:hidden;padding-left:45px;'></div>" +
				"<div id='selectMonth' style='z-index:+999;position:absolute;visibility:hidden;padding-left:70px;'></div>");
	}
	...
	function init()	{
		if (!ns4){
			...
			sHTML1="<span id='spanYear' style='padding-left:45px;border-width:0;cursor:pointer;' onmouseover='swapImage(\"changeYear\",\"drop2.gif\");window.status=\""+selectYearMessage+"\"' onmouseout='swapImage(\"changeYear\",\"drop1.gif\");window.status=\"\"' onclick='popUpYear()'></span>&nbsp;";
...
//		var	sTmp;
	...
	function constructMonth() {
		...
		if (!monthConstructed) {
			...
			document.getElementById("selectMonth").innerHTML = "<table width=40	style='font-family:arial; font-size:11px; border-width:1px; border-style:solid; border-color:#a0a0a0; background-color:#fff;' cellspacing=0 onmouseover='clearTimeout(timeoutID1)'	onmouseout='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"popDownMonth()\",100);event.cancelBubble=true'>" +	sHTML +	"</table>";
	...
	function constructYear() {
		...
		if (!yearConstructed) {
			...
			document.getElementById("selectYear").innerHTML	= "<table width=44 style='font-family:arial; font-size:11px; border-width:1px; border-style:solid; border-color:#a0a0a0; background-color:#fff;' onmouseover='clearTimeout(timeoutID2)' onmouseout='clearTimeout(timeoutID2);timeoutID2=setTimeout(\"popDownYear()\",100)' cellspacing=0>"	+ sHTML	+ "</table>";
   ...
   function WeekNbr(n) {
	...
	function constructCalendar() {
		...
		document.getElementById("spanMonth").innerHTML = "&nbsp;" +	monthName[monthSelected] + "&nbsp;<img id='changeMonth' src='"+imgDir+"drop1.gif' style='width:12px; height:10px; border:0px; margin-top:5px;'>";
		document.getElementById("spanYear").innerHTML =	"&nbsp;" + yearSelected	+ "&nbsp;<img id='changeYear' src='"+imgDir+"drop1.gif' style='width:12px; height:10px; border:0px; margin-top:5px;'>";
	}
